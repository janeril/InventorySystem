	...
	$row=mysqli_fetch_array($query);
	  ...
	  $_SESSION['name']=$name;		
		...
		mysqli_query($con,"INSERT INTO history_log(user_id,action,date) VALUES('$id','$remarks','$date')")or die(mysqli_error($con));
		 ...
		 else if($row['user_type']=="$Ako"){
			 		$remarks="has logged in the system at ";  
		mysqli_query($con,"INSERT INTO history_log(user_id,action,date) VALUES('$id','$remarks','$date')")or die(mysqli_error($con));
         
             echo "<script type='text/javascript'>document.location='pages/home_user.php'</script>";
        }
		 
		 else if($row['user_type']=="$IT"){
			 		$remarks="has logged in the system at ";  
		mysqli_query($conn,"INSERT INTO history_log(user_id,action,date) VALUES('$id','$remarks','$date')")or die(mysqli_error($con));
         
             echo "<script type='text/javascript'>document.location='inventory/inventory/pages/home.php'</script>";
        }
