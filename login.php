...
$query=mysqli_query($con,"select * from user natural join branch where username='$user' and password='$pass' and user_type='$Admin' and status='active'")or die(mysqli_error($con));
