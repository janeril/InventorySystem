			...
			<div class="row">
				<div class="col-md-12 col-sm-12 col-xs-12">
					<div class = "col-md-4 col-lg-4 col-xs-4">
						<?php include 'add_department_form.php';?>
					</div>
						...
						<div class = "x-panel">
						 <table id="datatable" class="table table-striped table-bordered">
							 ...
							 <tbody>
									<?php	
									include 'dbcon.php';								
										$query1=mysqli_query($con,"select * from department ORDER BY ID ASC")or die(mysqli_error($con));
								...
								<tr>
									...
									<td><?php echo $row1['Department_Contact'];?></td>
									<td>
