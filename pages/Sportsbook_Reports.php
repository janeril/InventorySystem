    ...
    <div class="wrapper">
     ...
     <section class="content-header">
		   ...
		   <ol class="breadcrumb">
              ...
              <li class="active">Sportsbook Department</li>
            </ol>
          </section>
...
include('../dist/includes/dbcon.php');
    ...
    $query=mysqli_query($con,"select * from branch where branch_name='$Sportsbook'")or die(mysqli_error());
...
include('../dist/includes/dbcon.php');
		...
		$query=mysqli_query($con,"select * from sportsbook_department where supplier_name='".$_POST['suppliers']."'")or die(mysqli_error($con));
...
?>
		...
		<?php }?>
		 ...
		 <th></th>
	 <th></th>
                      <th style="text-align:right;" colspan="12">Grand Total: 	
...
include('../dist/includes/dbcon.php');
		...
		$query=mysqli_query($con,"select * from sportsbook_department where cat_name='".$_POST['categories']."'")or die(mysqli_error($con));
		$count=mysqli_num_rows($query);
...
<?php
		...
		$query=mysqli_query($con,"select * from sportsbook_department where branch_name='$Sportsbook' and date(purchase_date)>='$start' and date(purchase_date)<='$end'")or die(mysqli_error($con));
		$count=mysqli_num_rows($query);
...
$CS= "CS Department";
		...
		$query=mysqli_query($con,"select * from sportsbook_department where branch_name='$Sportsbook'")or die(mysqli_error($con));
		$count=mysqli_num_rows($query);
