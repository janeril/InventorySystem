            ...
            <div class="col-xs-12">
              <div class="box box-primary">
                ...
                <div class="box-header" align="center">
                  <h3 class="box-title">Management Product List</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
...
<?php
		...
		$query=mysqli_query($con,"select * from management_department")or die(mysqli_error());
		while($row=mysqli_fetch_array($query)){
		
		$id = $row['prod_id'];
?>
                      <tr>
						<!--<td><img style="width:120px;height:100px" src="../dist/uploads/<?php echo $row['prod_pic'];?>"></td>-->
				...
				<b><a href="Management.php?delete=<?php echo $id;?>" onclick="return confirm('Are you sure?');"><span class="glyphicon glyphicon-remove" aria-hidden="true">Delete</td>
	  </a>
...
<div id="updateordinance<?php echo $row['prod_id'];?>" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
	...
	<div class="modal-dialog">
	  <div class="modal-content" style="height:auto">
			  ...
			  <form class="form-horizontal" method="post" action="management_produpdate.php" enctype='multipart/form-data'>
		...
		$Management = "Management Department";
          ...
          <div class="col-lg-9">
			 ...
			 <option value = "<?php echo $Management ?>"><?php echo $Management ?></option>
	  ...
	  <div class="form-group">
          ...
          <div class="col-lg-9">
            <input type="text" class="form-control" id="status" name="status" placeholder="Status" value="<?php echo $row['status'];?>"></textarea>  
          </div>
        </div> -->
...
<?php
		$id = $_SESSION['id'];
			...
			if(isset($_GET['delete'])){
				...
				mysqli_query($con,"Delete from management_department WHERE prod_id = '$delete_id'");
				$remarks="has deleted a product in Managament Department at";  
...
<div id="add" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
  <div class="modal-dialog">
    <div class="modal-content" style="height:auto">
              ...
              <div class="modal-body">
        <form class="form-horizontal" method="post" action="managementproduct+add.php" enctype='multipart/form-data'>
        <div class="form-group">
          <label class="control-label col-lg-3" for="price">Serial #</label>
          <div class="col-lg-9">
...
<!--		   <div class="form-group">
          <label class="control-label col-lg-3" for="price">Status</label>
          <div class="col-lg-9">
            <input type="text" class="form-control" id="status" name="status" placeholder="Status"></textarea>  
          </div>
        </div> -->
