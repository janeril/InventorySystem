        ...
        <!--<div class="container">-->
          ...
          <section class="content-header">
            <h1>
              ...
              <a class="btn btn-primary" href="#add" data-target="#add" data-toggle="modal" style="color:#fff;" class="small-box-footer"><i class="glyphicon glyphicon-plus text-blue"></i></a>
            </h1>
            <!-- <ol class="breadcrumb">
