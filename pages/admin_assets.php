...
<section class="content">
   ...
   <form method="POST" action="admin_assets+.php">
...
<br><br>
  ...
  <table id="example2" class="table table-bordered table-hover" class="mytable" cellspacing="0" width="100%">
	...
	<?php
		...
		$query=mysqli_query($con,"select * from admin_records_assets where date = '$today'")or die(mysqli_error());
...
?>
                   ...
                   <td><?php echo $row['Product_name'];?></td>
                      ...
                      <!--  <td><?php echo $row['Quantity'];?></td>-->
							...
							<td class= "hidden-print"><b><a href="admin_assets.php?delete=<?php echo $id;?>" onclick="return confirm('Are you sure?');"><span class="glyphicon glyphicon-remove" aria-hidden="true">Delete</td>
		...
		<?php
			...
			if(isset($_GET['delete'])){
				...
				mysqli_query($con,"Delete from admin_records_assets WHERE Product_id = '$delete_id'");
				echo "<script>document.location='admin_assets.php'</script>";  
		...
		<b><a href="export_admin.php" class= "hidden-print"><button type="button" class="btn btn-success btn-print">Export to Excel<span class="glyphicon glyphicon-success" aria-hidden="true">
