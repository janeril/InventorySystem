	...
	<div class="modal-dialog">
	  <div class="modal-content" style="height:auto">
        ...
        <div class="form-group">
          ...
          <div class="col-lg-9">
            <input type="text" class="form-control" id="name" name="desc" value="<?php echo $row['prod_model'];?>" required>  
          </div>
        </div> 
				<div class="form-group">
					...
					<div class="col-lg-9">
					    <select class="form-control select2" style="width: 100%;" name="supplier" required>
					      ...
					      <?php
							...
							$query2=mysqli_query($con,"select * from supplier natural join branch where branch_name='$branch_name'")or die(mysqli_error());
          ...
          <div class="col-lg-9">
            <input type="text" class="form-control" id="qty" name="prod_qty" placeholder="Quantity" value="<?php echo $row['prod_qty'];?>" required>  
              ...
              $queryc=mysqli_query($con,"select * from category natural join branch where branch_name='$branch_name' order by cat_name")or die(mysqli_error());
  ...
  <div class="modal-dialog">
    <div class="modal-content" style="height:auto">
        ...
        <div class="form-group">
          ...
          <div class="col-lg-9">
            <textarea class="form-control" id="price" name="prod_model" placeholder="Product Model"></textarea>  
          </div>
        </div>
        <div class="form-group">
          <label class="control-label col-lg-3" for="file">Supplier</label>
