    ...
    <div class="wrapper">
     ...
     <section class="content-header">
		   ...
		   <ol class="breadcrumb">
              ...
              <li class="active">Sales Department</li>
            </ol>
          </section>
...
include('../dist/includes/dbcon.php');
		...
		$query=mysqli_query($con,"select * from sales_department where supplier_name='".$_POST['suppliers']."'")or die(mysqli_error($con));
...
include('../dist/includes/dbcon.php');
		...
		$query=mysqli_query($con,"select * from sales_department where cat_name='".$_POST['categories']."'")or die(mysqli_error($con));
		$count=mysqli_num_rows($query);
...
<?php
		...
		$query=mysqli_query($con,"select * from sales_department where branch_name='$Sales' and date(purchase_date)>='$start' and date(purchase_date)<='$end'")or die(mysqli_error($con));
		$count=mysqli_num_rows($query);
...
$CS= "CS Department";
		...
		$query=mysqli_query($con,"select * from sales_department where branch_name='$Sales'")or die(mysqli_error($con));
		$count=mysqli_num_rows($query);
