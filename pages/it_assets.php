...
<br><br>
  ...
  <table id="example2" class="table table-bordered table-hover" class="mytable" cellspacing="0" width="100%">
	...
	<?php
		...
		$query=mysqli_query($con,"select * from it_records_assets where Date = '$today'")or die(mysqli_error());
...
?>
                   ...
                   <td><?php echo $row['Product_name'];?></td>
                      ...
                      <!--  <td><?php echo $row['Quantity'];?></td>-->
							...
							<td class= "hidden-print"><b><a href="it_assets.php?delete=<?php echo $id;?>" onclick="return confirm('Are you sure?');"><span class="glyphicon glyphicon-remove" aria-hidden="true">Delete</td>
		...
		<?php
			...
			if(isset($_GET['delete'])){
				...
				mysqli_query($con,"Delete from it_records_assets WHERE Product_id = '$delete_id'");
