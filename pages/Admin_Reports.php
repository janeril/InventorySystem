...
include('../dist/includes/dbcon.php');
    ...
    $query=mysqli_query($con,"select * from branch where branch_name='$Admin'")or die(mysqli_error());
...
include('../dist/includes/dbcon.php');
		...
		$query=mysqli_query($con,"select * from admin_department where supplier_name='".$_POST['suppliers']."'")or die(mysqli_error($con));
...
include('../dist/includes/dbcon.php');
		...
		$query=mysqli_query($con,"select * from admin_department where cat_name='".$_POST['categories']."'")or die(mysqli_error($con));
		$count=mysqli_num_rows($query);
...
<?php
		...
		$query=mysqli_query($con,"select * from admin_department where branch_name='$Admin' and date(purchase_date)>='$start' and date(purchase_date)<='$end'")or die(mysqli_error($con));
		$count=mysqli_num_rows($query);
...
$CS= "CS Department";
		...
		$query=mysqli_query($con,"select * from admin_department where branch_name='$Admin'")or die(mysqli_error($con));
		$count=mysqli_num_rows($query);
