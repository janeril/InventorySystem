            ...
            <div class="col-xs-12">
              <div class="box box-primary">
                ...
                <div class="box-header" align="center">
                  <h3 class="box-title">CS Department Product List</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
...
<?php
		...
		$query=mysqli_query($con,"select * from cs_department where branch_name='$CS' ")or die(mysqli_error());
...
?>
				...
				<b><a href="CS+Department.php?delete=<?php echo $id;?>" onclick="return confirm('Are you sure?');"><span class="glyphicon glyphicon-remove" aria-hidden="true">Delete</td>
	  </a>
						</td>
                      </tr>
<div id="updateordinance<?php echo $row['prod_id'];?>" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
	...
	<div class="modal-dialog">
	  <div class="modal-content" style="height:auto">
			  ...
			  <form class="form-horizontal" method="post" action="cs_produpdate.php" enctype='multipart/form-data'>
          ...
          <div class="col-lg-9">
            <input type="text" class="form-control" id="name" name="prod_model" value="<?php echo $row['prod_model'];?>" required>  
				...
				<div class="form-group">
					...
					<div class="col-lg-9">
					     <select class="form-control select2" style="width: 100%;" name="supplier_name" value="<?php echo $row['supplier_name'];?>">
          ...
          <div class="col-lg-9">
             <select  name = "location"  class="form-control pull-right">
			   <option value = "<?php echo $row['Location']?>"><?php echo $row['Location']?></option>
							...
							<option value = "CS Room">Sales Room</option>	
...
<?php
	$id = $_SESSION['id'];	
			...
			if(isset($_GET['delete'])){
				...
				mysqli_query($con,"Delete from cs_department WHERE prod_id = '$delete_id'");
				$remarks="has deleted a product in CS Department at";  
		mysqli_query($con,"INSERT INTO history_log(user_id,action,date) VALUES('$id','$remarks',NOW())")or die(mysqli_error($con));		
				echo "<script>document.location='CS+Department.php'</script>";  
...
<div id="add" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
  <div class="modal-dialog">
    <div class="modal-content" style="height:auto">
              ...
              <div class="modal-body">
        <form class="form-horizontal" method="post" action="csproduct+add.php" enctype='multipart/form-data'>
        <div class="form-group">
          <label class="control-label col-lg-3" for="price">Serial #</label>
          <div class="col-lg-9">
