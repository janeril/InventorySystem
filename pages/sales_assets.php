...
<script type="text/javascript">
	$(document).ready(function(e){
       ...
       <section class="content">
			...
			<form method="POST" action="sales_assets+.php">
...
include('../dist/includes/dbcon.php');
    ...
    $query=mysqli_query($con,"select * from branch where branch_name='$Sales'")or die(mysqli_error());
...
<br><br>
  ...
  <table id="example2" class="table table-bordered table-hover" class="mytable" cellspacing="0" width="100%">
	...
	<?php
		...
		$query=mysqli_query($con,"select * from sales_records_assets where Date = '$today'")or die(mysqli_error());
...
?>
                   ...
                   <td><?php echo $row['Product_name'];?></td>
                       ...
                       <!-- <td><?php echo $row['Quantity'];?></td>-->
							...
							<td class= "hidden-print"><b><a href="sales_assets.php?delete=<?php echo $id;?>" onclick="return confirm('Are you sure?');"><span class="glyphicon glyphicon-remove" aria-hidden="true">Delete</td>
		...
		<?php
			...
			if(isset($_GET['delete'])){
				...
				mysqli_query($con,"Delete from sales_records_assets WHERE Product_id = '$delete_id'");
				echo "<script>document.location='sales_assets.php'</script>";  
