...
include('../dist/includes/dbcon.php');
	...
	mysqli_query($con,"UPDATE management_department SET prod_name='$name',prod_price='$price',branch_name='$Management',
	...
	$remarks="has updated product in Management Department at";  
