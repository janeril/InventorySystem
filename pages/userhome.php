...
<html>
  ...
  <body class="hold-transition skin-<?php echo $_SESSION['skin'];?> layout-top-nav">
    <div class="wrapper">
      <?php include('../dist/includes/header_user.php');?>
      <!-- Full Width Column -->
      <div class="content-wrapper">
        <div class="container">
          ...
          <section class="content-header">
            <h1>
              <a class="btn btn-lg btn-warning" href="userhome.php">Back</a>
            </h1>
            <ol class="breadcrumb">
              <li><a href="userhome"><i class="fa fa-dashboard"></i> Home</a></li>
...
?>
                      <tr>
                        ...
                        <td>
				<a href="#updateordinance<?php echo $row['prod_id'];?>" data-target="#updateordinance<?php echo $row['prod_id'];?>" data-toggle="modal" style="color:#fff;" class="small-box-footer"><i class="glyphicon glyphicon-search text-blue">View</i></a>
	...
	<div class="modal-dialog">
	  <div class="modal-content" style="height:auto">
        ...
        <div class="form-group">
          ...
          <div class="col-lg-9">
            <input type="text" class="form-control" id="price" name="serial" value="<?php echo $row['serial'];?>" disabled="disabled" required>  
          </div>
        </div>
				...
				<div class="form-group">
					...
					<div class="col-lg-9"><input type="hidden" class="form-control" id="id" name="id" value="<?php echo $row['prod_id'];?>" required>  
					  <input type="text" class="form-control" id="name" name="prod_name" value="<?php echo $row['prod_name'];?>" disabled="disabled" required>  
					</div>
				</div> 
        <div class="form-group">
          <label class="control-label col-lg-3" for="name">Product Model</label>
          <div class="col-lg-9">
            <input type="text" class="form-control" id="name" name="prod_model" value="<?php echo $row['prod_model'];?>" disabled="disabled" required>  
          </div>
        </div> 
				<div class="form-group">
					<label class="control-label col-lg-3" for="file">Supplier</label>
					<div class="col-lg-9">
					     <select class="form-control select2" style="width: 100%;" name="supplier_name" value="<?php echo $row['supplier_name'];?>" disabled="disabled" required>
		...
		$Finance = "Finance Department";
          ...
          <div class="col-lg-9">
            <input type="text" class="form-control" id="qty" name="prod_qty" placeholder="Quantity" value="<?php echo $row['prod_qty'];?>" disabled="disabled" required>  
          </div>
		  
				<div class="form-group">
					<label class="control-label col-lg-3" for="price">Price</label>
					<div class="col-lg-9">
					  <input type="text" class="form-control" id="price" name="prod_price" value="<?php echo $row['prod_price'];?>" disabled="disabled" required>  
					</div>
				</div>
				...
				<div class="form-group">
							...
							<div class="col-lg-9">
							  <select class="form-control select2" style="width: 100%;" name="cat_name" value="<?php echo $row['cat_name'];?>"  disabled="disabled" required>
		...
		$Finance = "Finance Department";
			...
			<div class="form-group">
					    ...
					    <div class="col-sm-9"> 
					      <input type="date" class="form-control" name="purchase_date" id="purchase_date" value="<?php echo $row['purchase_date'];?>" disabled="disabled" required>			
        ...
        <div class="form-group">
					...
					<div class="col-lg-9">
					  <input type="hidden" class="form-control" id="price" name="image1"  value="<?php echo $row['prod_pic'];?>" required> 
					  <input type="file" class="form-control" id="price" name="image"  disabled="disabled" required>		  
			</div>
