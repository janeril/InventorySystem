            ...
            <div class="col-xs-12">
              <div class="box box-primary">
                ...
                <div class="box-header" align="center">
                  <h3 class="box-title">Production Department Product List</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
...
<?php
		...
		$i = 1;
		$query=mysqli_query($con,"select * from production_department where branch_name='$Production' ")or die(mysqli_error());
...
?>
				...
				<b><a href="Production+Department.php?delete=<?php echo $id;?>" onclick="return confirm('Are you sure?');"><span class="glyphicon glyphicon-remove" aria-hidden="true">Delete</td>
	  </a>
						</td>
                      </tr>
<div id="updateordinance<?php echo $row['prod_id'];?>" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
	...
	<div class="modal-dialog">
	  <div class="modal-content" style="height:auto">
			  ...
			  <form class="form-horizontal" method="post" action="production_produpdate.php" enctype='multipart/form-data'>
		...
		$HRAD = "HRAD Department";
          ...
          <div class="col-lg-9">
			 ...
			 <option value = "<?php echo $Production ?>"><?php echo $Production ?></option>
...
<?php
		$id = $_SESSION['id'];
			...
			if(isset($_GET['delete'])){
				...
				mysqli_query($con,"Delete from production_department WHERE prod_id = '$delete_id'");
				$remarks="has deleted a product in Production Department at";  
...
<div id="add" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
  <div class="modal-dialog">
    <div class="modal-content" style="height:auto">
              ...
              <div class="modal-body">
        <form class="form-horizontal" method="post" action="productionproduct+add.php" enctype='multipart/form-data'>
        <div class="form-group">
          <label class="control-label col-lg-3" for="price">Serial #</label>
          <div class="col-lg-9">
