    ...
    <div class="wrapper">
     ...
     <section class="content-header">
		   ...
		   <ol class="breadcrumb">
              ...
              <li class="active">Finance Department</li>
            </ol>
          </section>
...
include('../dist/includes/dbcon.php');
		...
		$query=mysqli_query($con,"select * from finance_department where supplier_name='".$_POST['suppliers']."'")or die(mysqli_error($con));
...
include('../dist/includes/dbcon.php');
		...
		$query=mysqli_query($con,"select * from finance_department where cat_name='".$_POST['categories']."'")or die(mysqli_error($con));
		$count=mysqli_num_rows($query);
...
<?php
		...
		$query=mysqli_query($con,"select * from finance_department where branch_name='$Finance' and date(purchase_date)>='$start' and date(purchase_date)<='$end'")or die(mysqli_error($con));
		$count=mysqli_num_rows($query);
...
<?php
		...
		$query=mysqli_query($con,"select * from finance_department where branch_name='$Finance'")or die(mysqli_error($con));
		$count=mysqli_num_rows($query);
