...
?>
				...
				<b><a href="IT+Department.php?delete=<?php echo $id;?>" onclick="return confirm('Are you sure?');"><span class="glyphicon glyphicon-remove" aria-hidden="true">Delete</td>
	  </a>
...
<?php
			...
			if(isset($_GET['delete'])){
				...
				mysqli_query($con,"Delete from it_department WHERE prod_id = '$delete_id'");
					$remarks="has deleted a product in IT Department at";  
  ...
  <div class="modal-dialog">
    <div class="modal-content" style="height:auto">
	   ...
	   <div class="form-group">
          <label class="control-label col-lg-3" for="price">Serial #</label>
          <div class="col-lg-9">
            <input type="text" class="form-control" id="price" name="serial" placeholder="Product Code">  
          </div>
        </div>
          ...
          <label class="control-label col-lg-3" for="price">Barcode Tag</label>
          <div class="col-lg-9">
            <input type="text" class="form-control" id="price" name="tag" placeholder="Barcode Tag">  
          </div>
        </div>
          ...
          <label class="control-label col-lg-3" for="price">Invoice No.</label>
          <div class="col-lg-9">
            <input type="text" class="form-control" id="price" name="invoice" placeholder="Invoice No.">  
          </div>
        </div>
        ...
        <div class="form-group">
              <label class="control-label col-lg-3" >Category</label>
              <div class="col-lg-9">
                <select class="form-control select2" style="width: 100%;" name="cat_name">
