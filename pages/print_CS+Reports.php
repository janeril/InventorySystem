...
?>       
        ...
        <?php echo $row['branch_name'];?> Department Status Report</div>
              ...
              <!-- main content -->
                ...
                <a class = "btn btn-primary btn-print" href = "home_user.php"><i class ="glyphicon glyphicon-arrow-left"></i> Back to Homepage</a>
              </div><!-- /.box -->
