...
<script type="text/javascript">
	$(document).ready(function(e){
       ...
       <section class="content">
			...
			<form method="POST" action="ws_assets+.php">
...
include('../dist/includes/dbcon.php');
    ...
    $query=mysqli_query($con,"select * from branch where branch_name='$WS'")or die(mysqli_error());
...
<br><br>
  ...
  <table id="example2" class="table table-bordered table-hover" class="mytable" cellspacing="0" width="100%">
	...
	<?php
		...
		$query=mysqli_query($con,"select * from ws_records_assets where Date = '$today'")or die(mysqli_error());
...
?>
                 ...
                 <!--       <td><?php echo $row['Quantity'];?></td>-->
							...
							<td class= "hidden-print"><b><a href="ws_assets.php?delete=<?php echo $id;?>" onclick="return confirm('Are you sure?');"><span class="glyphicon glyphicon-remove" aria-hidden="true">Delete</td>
		...
		<?php
			...
			if(isset($_GET['delete'])){
				...
				mysqli_query($con,"Delete from ws_records_assets WHERE Product_id = '$delete_id'");
				echo "<script>document.location='ws_assets.php'</script>";  
