...
include('../dist/includes/dbcon.php');
	...
	$today = date("Y-m-d");
		...
		$query2=mysqli_query($con,"select * from hr_department where serial = '$barcodes'")or die(mysqli_error($con));
		...
		if ($count==0)
		{
			...
			mysqli_query($con,"INSERT INTO hr_records_assets(Serial,Product_name,Price,Product_model,Category,Supplier,Quantity,Purchase_date,Date,Department,Invoice_No,Location,Barcode,status,assigned_to,assigned_date)
