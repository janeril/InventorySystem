            ...
            <div class="col-xs-12">
              <div class="box box-primary">
                ...
                <div class="box-header" align="center">
                  <h3 class="box-title">Sportsbook Department Product List</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
...
<?php
		...
		$query=mysqli_query($con,"select * from sportsbook_department where branch_name='$Sportsbook' ")or die(mysqli_error());
...
?>
				...
				<a href="#updateordinance<?php echo $row['prod_id'];?>" data-target="#updateordinance<?php echo $row['prod_id'];?>" data-toggle="modal" style="color:#fff;" class="small-box-footer"><i class="glyphicon glyphicon-edit text-blue">Edit</i></a>
					<b><a href="Sportsbook+Department.php?delete=<?php echo $id;?>" onclick="return confirm('Are you sure?');"><span class="glyphicon glyphicon-remove" aria-hidden="true">Delete</td>
	  </a>
						</td>
                      </tr>
<div id="updateordinance<?php echo $row['prod_id'];?>" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
	...
	<div class="modal-dialog">
	  <div class="modal-content" style="height:auto">
			  ...
			  <form class="form-horizontal" method="post" action="sportsbook_produpdate.php" enctype='multipart/form-data'>
		...
		$HRAD = "HRAD Department";
          ...
          <div class="col-lg-9">
			 ...
			 <option value = "<?php echo $Sportsbook ?>"><?php echo $Sportsbook ?></option>
...
<?php
			...
			if(isset($_GET['delete'])){
				...
				mysqli_query($con,"Delete from sportsbook_department WHERE prod_id = '$delete_id'");
				$remarks="has deleted a product in Sportsbook Department at";  
		mysqli_query($con,"INSERT INTO history_log(user_id,action,date) VALUES('$id','$remarks',NOW())")or die(mysqli_error($con));	
				echo "<script>document.location='Sportsbook+Department.php'</script>";  
...
<div id="add" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
  <div class="modal-dialog">
    <div class="modal-content" style="height:auto">
              ...
              <div class="modal-body">
        <form class="form-horizontal" method="post" action="sportsbookproduct+add.php" enctype='multipart/form-data'>
        <div class="form-group">
          <label class="control-label col-lg-3" for="price">Serial #</label>
          <div class="col-lg-9">
