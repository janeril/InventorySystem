            ...
            <div class="col-xs-12">
              <div class="box box-primary">
                ...
                <div class="box-header" align="center">
                  <h3 class="box-title">Quality Assurance Department Product List</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
...
<?php
		...
		$query=mysqli_query($con,"select * from qa_department ")or die(mysqli_error());
...
?>
				...
				<b><a href="QA+Department.php?delete=<?php echo $id;?>" onclick="return confirm('Are you sure?');"><span class="glyphicon glyphicon-remove" aria-hidden="true">Delete</td>
	  </a>
						</td>
                      </tr>
<div id="updateordinance<?php echo $row['prod_id'];?>" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
	...
	<div class="modal-dialog">
	  <div class="modal-content" style="height:auto">
			  ...
			  <form class="form-horizontal" method="post" action="qa_produpdate.php" enctype='multipart/form-data'>
		...
		$NewFire= "New Fire Lottery Department";
          ...
          <div class="col-lg-9">
			 ...
			 <option value = "<?php echo $QA ?>"><?php echo $QA?></option>
							...
							<option value = "Quality Assurance Room">Quality Assurance Room</option>
							<option value = "New Fire Lottery Room">New Fire Lottery Room</option>
		</select>
...
<?php
			...
			if(isset($_GET['delete'])){
				...
				mysqli_query($con,"Delete from qa_department WHERE prod_id = '$delete_id'");
					$remarks="has deleted a product in Quality Assurance Department at";  
		mysqli_query($con,"INSERT INTO history_log(user_id,action,date) VALUES('$id','$remarks',NOW())")or die(mysqli_error($con));		
				echo "<script>document.location='QA+Department.php'</script>";  
...
<div id="add" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
  <div class="modal-dialog">
    <div class="modal-content" style="height:auto">
              ...
              <div class="modal-body">
        <form class="form-horizontal" method="post" action="qaproduct+add.php" enctype='multipart/form-data'>
        <div class="form-group">
          <label class="control-label col-lg-3" for="price">Serial #</label>
          <div class="col-lg-9">
        ...
        <div class="form-group">
          ...
          <div class="col-lg-9">
			 ...
			 <option value = "<?php echo $QA ?>"><?php echo $QA ?></option>
							...
							<option value = "New Fire Lottery Department">New Fire Lottery Department</option>
		</select>
