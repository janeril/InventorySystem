            ...
            <div class="col-xs-12">
              <div class="box box-primary">
                ...
                <div class="box-header" align="center">
                  <h3 class="box-title">New Fire Lottery Department Product List</h3>
                </div><!-- /.box-header -->
                <div class="box-body">
...
<?php
		...
		$query=mysqli_query($con,"select * from newfire_department ")or die(mysqli_error());
...
?>
				...
				<b><a href="Newfire+Department.php?delete=<?php echo $id;?>" onclick="return confirm('Are you sure?');"><span class="glyphicon glyphicon-remove" aria-hidden="true">Delete</td>
	  </a>
						</td>
                      </tr>
<div id="updateordinance<?php echo $row['prod_id'];?>" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
	...
	<div class="modal-dialog">
	  <div class="modal-content" style="height:auto">
			  ...
			  <form class="form-horizontal" method="post" action="newfire_produpdate.php" enctype='multipart/form-data'>
		...
		$Newfire = "New Fire Lottery Department";
          ...
          <div class="col-lg-9">
			 ...
			 <option value = "<?php echo $Newfire ?>"><?php echo $Newfire ?></option>
...
<?php
			...
			if(isset($_GET['delete'])){
				...
				mysqli_query($con,"Delete from newfire_department WHERE prod_id = '$delete_id'");
					$remarks="has deleted a product in New Fire Lottery Department at";  
...
<div id="add" class="modal fade in" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" style="display: none;">
  <div class="modal-dialog">
    <div class="modal-content" style="height:auto">
              ...
              <div class="modal-body">
        <form class="form-horizontal" method="post" action="newfireproduct+add.php" enctype='multipart/form-data'>
        <div class="form-group">
          <label class="control-label col-lg-3" for="price">Serial #</label>
          <div class="col-lg-9">
